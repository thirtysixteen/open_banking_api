...
# Unit tests for OpenBanking::Customer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenBanking::Customer do
  let(:instance) { OpenBanking::Customer.new }

  describe 'test an instance of Customer' do
    it 'should create an instance of Customer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenBanking::Customer)
    end
  end
