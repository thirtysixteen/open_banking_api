...
# Unit tests for OpenBanking::FinancialInstitution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenBanking::FinancialInstitution do
  let(:instance) { OpenBanking::FinancialInstitution.new }

  describe 'test an instance of FinancialInstitution' do
    it 'should create an instance of FinancialInstitution' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenBanking::FinancialInstitution)
    end
  end
