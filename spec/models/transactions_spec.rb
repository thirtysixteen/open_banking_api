...
# Unit tests for OpenBanking::Transactions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenBanking::Transactions do
  let(:instance) { OpenBanking::Transactions.new }

  describe 'test an instance of Transactions' do
    it 'should create an instance of Transactions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenBanking::Transactions)
    end
  end
