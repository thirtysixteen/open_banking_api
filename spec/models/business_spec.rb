...
# Unit tests for OpenBanking::Business
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenBanking::Business do
  let(:instance) { OpenBanking::Business.new }

  describe 'test an instance of Business' do
    it 'should create an instance of Business' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenBanking::Business)
    end
  end
