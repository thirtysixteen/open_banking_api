...
module OpenBanking
  class VOAWithIncomeReportConstraintsOut
    ...
    def self.attribute_map
      {
        ...
        :'show_nsf' => :'showNsf',
        :'from_date' => :'fromDate',
        :'voai_pdf_deposit_view' => :'voaiPdfDepositView',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::VOAWithIncomeReportConstraintsOut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::VOAWithIncomeReportConstraintsOut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'show_nsf')
        self.show_nsf = attributes[:'show_nsf']
      end
      ...
      if attributes.key?(:'voai_pdf_deposit_view')
        self.voai_pdf_deposit_view = attributes[:'voai_pdf_deposit_view']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          voai_pdf_deposit_view == o.voai_pdf_deposit_view &&
    ...
    def hash
      [account_ids, report_custom_fields, show_nsf, from_date, voai_pdf_deposit_view, income_stream_confidence_minimum].hash
    end
