  ...
  class EmailOptions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::EmailOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::EmailOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'support_phone')
      ...
      if attributes.key?(:'institution_address')
        self.institution_address = attributes[:'institution_address']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          institution_address == o.institution_address &&
    ...
    def hash
      [to, from, support_phone, subject, first_name, institution_name, institution_address, signature].hash
    end
