...
module OpenBanking
  class MainPayStatementFields
    ...
    attr_accessor :pay_period_hours
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::MainPayStatementFields` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::MainPayStatementFields`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pay_period_hours')
        self.pay_period_hours = attributes[:'pay_period_hours']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          pay_period_hours == o.pay_period_hours &&
    ...
    def hash
      [pay_date, start_date, end_date, pay_period_hours, pay_frequency, pay_type, gross_pay_amount, gross_pay_amount_ytd, net_pay_amount, net_pay_amount_ytd].hash
    end
