  ...
  class PayStat
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::PayStat` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::PayStat`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'amount_current')
        self.amount_current = attributes[:'amount_current']
      end

      if attributes.key?(:'amount_ytd')
        self.amount_ytd = attributes[:'amount_ytd']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rate == o.rate &&
          units == o.units &&
          amount_current == o.amount_current &&
          amount_ytd == o.amount_ytd
    end
    ...
    def hash
      [name, type, description, rate, units, amount_current, amount_ytd].hash
    end
