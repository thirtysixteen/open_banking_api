...
module OpenBanking
  class TransactionsReportConstraintsOut
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::TransactionsReportConstraintsOut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::TransactionsReportConstraintsOut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'include_pending')
        self.include_pending = attributes[:'include_pending']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          to_date == o.to_date &&
          include_pending == o.include_pending &&
    ...
    def hash
      [account_ids, from_date, to_date, include_pending, report_custom_fields].hash
    end
