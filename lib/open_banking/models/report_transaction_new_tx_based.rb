...
module OpenBanking
  class ReportTransactionNewTxBased
    # A transaction ID
    attr_accessor :id
    ...
    attr_accessor :normalized_payee

    # The unique identifier given by the FI for each transaction
    attr_accessor :institution_transaction_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::ReportTransactionNewTxBased` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::ReportTransactionNewTxBased`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'normalized_payee')
        self.normalized_payee = attributes[:'normalized_payee']
      end

      if attributes.key?(:'institution_transaction_id')
        self.institution_transaction_id = attributes[:'institution_transaction_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          memo == o.memo &&
          normalized_payee == o.normalized_payee &&
          institution_transaction_id == o.institution_transaction_id &&
          category == o.category &&
          type == o.type &&
    ...
    def hash
      [id, amount, posted_date, description, memo, normalized_payee, institution_transaction_id, category, type, security_type, symbol, commission, investment_transaction_type].hash
    end
