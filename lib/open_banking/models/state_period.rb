  ...
  class StatePeriod
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::StatePeriod` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::StatePeriod`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'beginning_value')
        self.beginning_value = attributes[:'beginning_value']
      else
        self.beginning_value = nil
      end
      ...
      if attributes.key?(:'ending_value')
        self.ending_value = attributes[:'ending_value']
      else
    ...
    def list_invalid_properties
      ...
      if @beginning_value.nil?
        invalid_properties.push('invalid value for "beginning_value", beginning_value cannot be nil.')
      end
      ...
      if @ending_value.nil?
        invalid_properties.push('invalid value for "ending_value", ending_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @beginning_value.nil?
      return false if @count.nil?
      return false if @end_date.nil?
      return false if @ending_value.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          beginning_value == o.beginning_value &&
          count == o.count &&
          end_date == o.end_date &&
          ending_value == o.ending_value &&
          max == o.max &&
          mean == o.mean &&
          median == o.median &&
          min == o.min &&
    ...
    def hash
      [beginning_value, count, end_date, ending_value, max, mean, median, min, standard_deviation, start_date, sum].hash
    end
