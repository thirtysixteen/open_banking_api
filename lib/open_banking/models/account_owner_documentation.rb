  ...
  class AccountOwnerDocumentation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::AccountOwnerDocumentation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::AccountOwnerDocumentation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tax_id_country')
        self.tax_id_country = attributes[:'tax_id_country']
      end

      if attributes.key?(:'government_id')
        self.government_id = attributes[:'government_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tax_id == o.tax_id &&
          tax_id_country == o.tax_id_country &&
    ...
    def hash
      [tax_id, tax_id_country, government_id].hash
    end
