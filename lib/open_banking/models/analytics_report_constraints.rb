...
module OpenBanking
  class AnalyticsReportConstraints
    attr_accessor :analytics_report_data
    ...
    def self.attribute_map
      {
        :'analytics_report_data' => :'analyticsReportData',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::AnalyticsReportConstraints` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::AnalyticsReportConstraints`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'analytics_report_data')
        self.analytics_report_data = attributes[:'analytics_report_data']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          analytics_report_data == o.analytics_report_data &&
    ...
    def hash
      [analytics_report_data, account_ids, report_custom_fields, from_date].hash
    end
