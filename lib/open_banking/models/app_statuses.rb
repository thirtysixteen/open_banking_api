  ...
  class AppStatuses
    ...
    def self.openapi_types
      {
        ...
        :'total_pages' => :'Integer',
        :'page_number' => :'Integer',
        :'number_of_records_per_page' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::AppStatuses` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::AppStatuses`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_records_per_page')
        self.number_of_records_per_page = attributes[:'number_of_records_per_page']
      else
        self.number_of_records_per_page = nil
      end
    ...
    def list_invalid_properties
      ...
      if @total_records.nil?
        invalid_properties.push('invalid value for "total_records", total_records cannot be nil.')
      end
      ...
      if @number_of_records_per_page.nil?
        invalid_properties.push('invalid value for "number_of_records_per_page", number_of_records_per_page cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @total_records.nil?
      return false if @total_pages.nil?
      return false if @page_number.nil?
      return false if @number_of_records_per_page.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_of_records_per_page == o.number_of_records_per_page &&
    ...
    def hash
      [total_records, total_pages, page_number, number_of_records_per_page, applications].hash
    end
