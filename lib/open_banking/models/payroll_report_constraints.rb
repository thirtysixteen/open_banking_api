...
module OpenBanking
  class PayrollReportConstraints
    ...
    attr_accessor :pay_statements_from_date
    ...
    attr_accessor :exclude_emp_info
    ...
    def self.openapi_types
      {
        ...
        :'pay_statements_from_date' => :'Integer',
        :'market_segment' => :'String',
        :'exclude_emp_info' => :'Boolean',
        :'purpose' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::PayrollReportConstraints` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::PayrollReportConstraints`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'payroll_data')
        self.payroll_data = attributes[:'payroll_data']
      else
        self.payroll_data = nil
      end
      ...
      if attributes.key?(:'pay_statements_from_date')
        self.pay_statements_from_date = attributes[:'pay_statements_from_date']
      end
      ...
      if attributes.key?(:'exclude_emp_info')
        self.exclude_emp_info = attributes[:'exclude_emp_info']
      end
    ...
    def list_invalid_properties
      ...
      if @payroll_data.nil?
        invalid_properties.push('invalid value for "payroll_data", payroll_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payroll_data.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          payroll_data == o.payroll_data &&
          report_custom_fields == o.report_custom_fields &&
          pay_statements_from_date == o.pay_statements_from_date &&
          market_segment == o.market_segment &&
          exclude_emp_info == o.exclude_emp_info &&
          purpose == o.purpose
    end
    ...
    def hash
      [payroll_data, report_custom_fields, pay_statements_from_date, market_segment, exclude_emp_info, purpose].hash
    end
