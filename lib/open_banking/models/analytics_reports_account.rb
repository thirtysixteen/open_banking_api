...
module OpenBanking
  class AnalyticsReportsAccount
    ...
    attr_accessor :account_analytics
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::AnalyticsReportsAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::AnalyticsReportsAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_analytics')
        self.account_analytics = attributes[:'account_analytics']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          details == o.details &&
          account_analytics == o.account_analytics
    end
    ...
    def hash
      [id, owner_name, owner_address, name, number, type, currency, aggregation_status_code, current_balance, available_balance, balance_date, transactions, details, account_analytics].hash
    end
