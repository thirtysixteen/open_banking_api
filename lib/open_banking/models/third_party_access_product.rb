  ...
  class ThirdPartyAccessProduct
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::ThirdPartyAccessProduct` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::ThirdPartyAccessProduct`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_calls')
        self.max_calls = attributes[:'max_calls']
      end
      ...
      if attributes.key?(:'access_period')
        self.access_period = attributes[:'access_period']
      else
        self.access_period = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @access_period.nil?
        invalid_properties.push('invalid value for "access_period", access_period cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @access_period.nil?
      true
    end
    ...
    def hash
      [product, payor_id, max_calls, account_id, access_period].hash
    end
