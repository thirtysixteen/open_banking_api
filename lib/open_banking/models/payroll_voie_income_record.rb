...
module OpenBanking
  class PayrollVOIEIncomeRecord
    ...
    attr_accessor :base_pay_rate_unit
    ...
    attr_accessor :oldest_pay_statement_available
    ...
    attr_accessor :direct_pay_statements
    ...
    def self.openapi_types
      {
        ...
        :'monthly_income' => :'MonthlyIncome',
        :'direct_pay_statements' => :'Array<DirectPayStatements>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::PayrollVOIEIncomeRecord` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::PayrollVOIEIncomeRecord`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'base_pay_rate')
        self.base_pay_rate = attributes[:'base_pay_rate']
      end

      if attributes.key?(:'base_pay_rate_unit')
        self.base_pay_rate_unit = attributes[:'base_pay_rate_unit']
      end

      if attributes.key?(:'oldest_pay_statement_available')
        self.oldest_pay_statement_available = attributes[:'oldest_pay_statement_available']
      end

      if attributes.key?(:'annual_income')
        if (value = attributes[:'annual_income']).is_a?(Array)
      ...
      if attributes.key?(:'direct_pay_statements')
        if (value = attributes[:'direct_pay_statements']).is_a?(Array)
          self.direct_pay_statements = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pay_type == o.pay_type &&
          base_pay_rate == o.base_pay_rate &&
          base_pay_rate_unit == o.base_pay_rate_unit &&
          oldest_pay_statement_available == o.oldest_pay_statement_available &&
          annual_income == o.annual_income &&
          monthly_income == o.monthly_income &&
          direct_pay_statements == o.direct_pay_statements
    end
    ...
    def hash
      [pay_frequency, pay_type, base_pay_rate, base_pay_rate_unit, oldest_pay_statement_available, annual_income, monthly_income, direct_pay_statements].hash
    end
