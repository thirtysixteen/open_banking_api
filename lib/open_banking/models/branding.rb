  ...
  class Branding
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenBanking::Branding` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenBanking::Branding`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'alternate_logo')
        self.alternate_logo = attributes[:'alternate_logo']
      end
      ...
      if attributes.key?(:'tile')
        self.tile = attributes[:'tile']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          logo == o.logo &&
          alternate_logo == o.alternate_logo &&
          icon == o.icon &&
    ...
    def hash
      [logo, alternate_logo, icon, primary_color, tile].hash
    end
