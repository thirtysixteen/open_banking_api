...
module OpenBanking
  class BalanceAnalyticsApi
    ...
    def generate_balance_analytics(customer_id, balance_and_cash_flow_analytics_report_constraints, opts = {})
      data, _status_code, _headers = generate_balance_analytics_with_http_info(customer_id, balance_and_cash_flow_analytics_report_constraints, opts)
      data
    end
    ...
    def generate_balance_analytics_with_http_info(customer_id, balance_and_cash_flow_analytics_report_constraints, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BalanceAnalyticsApi.generate_balance_analytics ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling BalanceAnalyticsApi.generate_balance_analytics"
      end
      ...
      if @api_client.config.client_side_validation && balance_and_cash_flow_analytics_report_constraints.nil?
        fail ArgumentError, "Missing the required parameter 'balance_and_cash_flow_analytics_report_constraints' when calling BalanceAnalyticsApi.generate_balance_analytics"
      end
      # resource path
      local_var_path = '/analytics/balance/v1/customer/{customerId}'.sub('{' + 'customerId' + '}', CGI.escape(customer_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"BalanceAnalyticsApi.generate_balance_analytics",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BalanceAnalyticsApi#generate_balance_analytics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :reference_number Partner-provided reference number to correlate reports.
    # @return [ObbAnalyticsReportAck]
    def generate_balance_analytics_fcra(customer_id, balance_and_cash_flow_analytics_report_constraints, opts = {})
      data, _status_code, _headers = generate_balance_analytics_fcra_with_http_info(customer_id, balance_and_cash_flow_analytics_report_constraints, opts)
      data
    end
    ...
    # @option opts [String] :reference_number Partner-provided reference number to correlate reports.
    # @return [Array<(ObbAnalyticsReportAck, Integer, Hash)>] ObbAnalyticsReportAck data, response status code and response headers
    def generate_balance_analytics_fcra_with_http_info(customer_id, balance_and_cash_flow_analytics_report_constraints, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BalanceAnalyticsApi.generate_balance_analytics_fcra ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling BalanceAnalyticsApi.generate_balance_analytics_fcra"
      end
      # verify the required parameter 'balance_and_cash_flow_analytics_report_constraints' is set
      if @api_client.config.client_side_validation && balance_and_cash_flow_analytics_report_constraints.nil?
        fail ArgumentError, "Missing the required parameter 'balance_and_cash_flow_analytics_report_constraints' when calling BalanceAnalyticsApi.generate_balance_analytics_fcra"
      end
      # resource path
      local_var_path = '/analytics/balance/v1/customer/{customerId}/fcra'.sub('{' + 'customerId' + '}', CGI.escape(customer_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"BalanceAnalyticsApi.generate_balance_analytics_fcra",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BalanceAnalyticsApi#generate_balance_analytics_fcra\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_balance_analytics_report(customer_id, user_type, analytics_report_constraints, opts = {})
      data, _status_code, _headers = generate_balance_analytics_report_with_http_info(customer_id, user_type, analytics_report_constraints, opts)
      data
    end
    ...
    def generate_balance_analytics_report_with_http_info(customer_id, user_type, analytics_report_constraints, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BalanceAnalyticsApi.generate_balance_analytics_report ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling BalanceAnalyticsApi.generate_balance_analytics_report"
      end
      # verify the required parameter 'user_type' is set
      if @api_client.config.client_side_validation && user_type.nil?
        fail ArgumentError, "Missing the required parameter 'user_type' when calling BalanceAnalyticsApi.generate_balance_analytics_report"
      end
      ...
      if @api_client.config.client_side_validation && analytics_report_constraints.nil?
        fail ArgumentError, "Missing the required parameter 'analytics_report_constraints' when calling BalanceAnalyticsApi.generate_balance_analytics_report"
      end
      # resource path
      local_var_path = '/decisioning/v2/customers/{customerId}/reports/balance-analytics/userTypes/{userType}'.sub('{' + 'customerId' + '}', CGI.escape(customer_id.to_s)).sub('{' + 'userType' + '}', CGI.escape(user_type.to_s))
      ...
      new_options = opts.merge(
        :operation => :"BalanceAnalyticsApi.generate_balance_analytics_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BalanceAnalyticsApi#generate_balance_analytics_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_obb_analytics_report_with_http_info(obb_report_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BalanceAnalyticsApi.get_obb_analytics_report ...'
      end
      # verify the required parameter 'obb_report_id' is set
      if @api_client.config.client_side_validation && obb_report_id.nil?
        fail ArgumentError, "Missing the required parameter 'obb_report_id' when calling BalanceAnalyticsApi.get_obb_analytics_report"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"BalanceAnalyticsApi.get_obb_analytics_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BalanceAnalyticsApi#get_obb_analytics_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_obb_analytics_report_fcra_with_http_info(obb_report_id, purpose, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BalanceAnalyticsApi.get_obb_analytics_report_fcra ...'
      end
      # verify the required parameter 'obb_report_id' is set
      if @api_client.config.client_side_validation && obb_report_id.nil?
        fail ArgumentError, "Missing the required parameter 'obb_report_id' when calling BalanceAnalyticsApi.get_obb_analytics_report_fcra"
      end
      # verify the required parameter 'purpose' is set
      if @api_client.config.client_side_validation && purpose.nil?
        fail ArgumentError, "Missing the required parameter 'purpose' when calling BalanceAnalyticsApi.get_obb_analytics_report_fcra"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"BalanceAnalyticsApi.get_obb_analytics_report_fcra",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BalanceAnalyticsApi#get_obb_analytics_report_fcra\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
